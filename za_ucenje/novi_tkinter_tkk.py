...
class PyFlora:
    ...
    def __init__(self, repozitorij):
        ...
        self.style.configure('ButtonStyle.TButton', 
            font=('Quicksand', 10), foreground="white",background="grey",
            borderwidth=0, bootstyle="warning-inverse")
    ...
    def unos_korisnicko_ime_i_lozinka(self):
        oznaka_username = ttk.Label(
            ...
            font="quicksand, 14",bootstyle="dark",background='#f3f6f4')
        ...
        self.password = ttk.Entry(self.root, bootstyle="warning",show="*",background='#f3f6f4')
    ...
    def nacrtaj_naslovnicu_aplikacije(self):
        ...
        tekst_pozdrava = ttk.Label(self.root,
                ...
                bootstyle='warning-inverse',font="quicksand 14",padding=5, anchor="center")
    ...
    def prozor_ulaska_login_ili_registracija(self):
        ...
        tekst_pozdrava = ttk.Label(self.root, 
               ...
               bootstyle='succes-inverse', anchor="center")#, image=self.mali_crno_bijeli_logo(self.root))
        tekst_pozdrava.place(anchor="center", relx=0.5,rely=0.15)

        button_ulogiraj = ttk.Button(
            self.root, bootstyle="warning-outline-toolbutton", 
        ...
        button_novi_korisnik = ttk.Button(
            self.root, bootstyle="warning-toolbutton",
    ...
    def prozor_za_dodavanje_novog_korisnika(self):
        ...
        button_ulogiraj = ttk.Button(
            self.root, text='registriraj korisnika', bootstyle="warning-toolbutton", 
    ...
    def nacrtaj_prvi_prozor_login(self): 
        ...
        button_ulogiraj = ttk.Button(
            self.root, text='login', bootstyle="warning-outline", 
    ...
    def nacrtaj_drugi_prozor(self, username):
        ...
        button_za_nastavak = ttk.Button(
            self.root, text="let's go!", bootstyle="warning-outline", 
    ...
    def dodajte_novu_biljku_iz_foldera(self):
        ...
        ime_nove_biljke = ttk.Label(self.root, text='ime biljke', font="quicksand, 13",bootstyle="light-inverse" )
        ...
        slika_nove_biljke = ttk.Label(self.root, text='odaberite sliku', font="quicksand, 13",bootstyle="light-inverse" )
    ...
    def gumb_sinkronizacije(self):
        ...
        gumb_sinkronizacije = ttk.Button(self.root,
                        ...
                        padding=10, width=16 )
        gumb_sinkronizacije.place(x=744,y=70)
    ...
    def nacrtaj_header(self, tekst):
        ...
        gumb_moj_profil = ttk.Button(header,
                        text="moj profil", bootstyle= "warning-outline-toolbutton",
                        command= self.nacrtaj_treci_prozor_moj_profil, padding=10, width=30)
    ...
    def ubaci_tekst_u_label(self, neki_frame,ime_slike):
        oznaka = ttk.Label(
            neki_frame, 
            text=f'{ime_slike}',
            font="quicksand, 15", justify='left',bootstyle="warning")   # svijetlo zuta - FFE890
        oznaka.place(anchor ='center', relx=0.3, rely=0.2)

        status_biljke = ttk.Label(
            neki_frame, 
            text='Status: \nVlažnost tla: \nSvjetlost: ',
            font="quicksand, 8", bootstyle= "default", justify='left')   # svijetlo zuta - FFE890
    ...
    def prikaz_sadrzaja_synca_autori(self):
        ...
        e=ttk.Label(self.root,width=10,text='autorid',font=("calibre", 10, "normal"),fg='#0c4f4e',borderwidth=2, anchor='center',bg='#f3f6f4')
        e.grid(row=0,column=0)
        e=ttk.Label(self.root,width=10,text='NAME',font=("calibre", 10, "normal"),fg='#0c4f4e',borderwidth=2,anchor='center',bg='#f3f6f4')
        e.grid(row=0,column=1)
        e=ttk.Label(self.root,width=10,text='EMAIL',font=("calibre", 10, "normal"),fg='#0c4f4e',borderwidth=2,anchor='center',bg='#f3f6f4')
        e.grid(row=0,column=2)
        ...
        for user in tablica_korisnika: 
            ...
            i=i+1
        button_povratak = ttk.Button(self.root, text="go back", 
        ...
        button_poceteak = ttk.Button(self.root, text="go to login", 
